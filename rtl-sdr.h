...
RTLSDR_API void rtlsdr_printf(const char *fmt, ...);
 ...
 * \return 0 on success
 */
//RTLSDR_API int rtlsdr_get_device_usb_strings(uint32_t index, char *product, char *serial);
RTLSDR_API int rtlsdr_get_device_usb_strings(uint32_t index, char **name, char *product, char *serial);
 ...
 */
RTLSDR_API int rtlsdr_search_for_device(char *s);
 ...
 */
RTLSDR_API int rtlsdr_get_tuner_bandwidths(rtlsdr_dev_t *dev, unsigned int *bandwidths);
 ...
 * \return 0 on success
 */
RTLSDR_API int rtlsdr_set_tuner_bandwidth(rtlsdr_dev_t *dev, unsigned int bandwidth);
 ...
 * \return <= 0 on error, number of available (returned) gain values otherwise
 */
RTLSDR_API int rtlsdr_get_tuner_gains(rtlsdr_dev_t *dev, unsigned int *lna_gains, unsigned int *mixer_gains, unsigned int *num_lna_gains, unsigned int *num_mixer_gains);

/*!
 * Set the gain for the device.
 * Manual gain mode must be enabled for this to work.
 *
 * Gains are from 0dB to 45dB, with a step of 2.5dB
 *
 * \param dev the device handle given by rtlsdr_open()
 * \param gain in tenths of a dB, 115 means 11.5 dB.
 * \return 0 on success
 */
RTLSDR_API int rtlsdr_set_tuner_gain(rtlsdr_dev_t *dev, unsigned int gain);
...
RTLSDR_API int rtlsdr_read_sync(rtlsdr_dev_t *dev, void *buf, unsigned int len, unsigned int *n_read);
 ...
 * \param buf_len optional buffer length, must be multiple of 16384,
 *		  set to 0 for default buffer length (15 * 16384)
 * \return 0 on success
 */
